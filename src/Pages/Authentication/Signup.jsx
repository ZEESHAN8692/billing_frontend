...
import { signupUser } from "../../Redux/Slice/registrationSlice";
...
const Signup = () => {
  ...
  return (
    <>
      ...
      <div className="min-w-screen min-h-screen bg-[#DADDEC] flex items-center justify-center px-5 py-5">
        <div
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <div className="flex -mx-3">
                    ...
                    <div className="w-full px-3 mb-12">
                      ...
                      <div className="flex">
                        <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                          <i className="mdi mdi-image-outline text-gray-400 text-lg" />
                        </div>
                        <input
                          type="file"
                          className={`w-full -ml-10 pl-2 pr-3 py-2 rounded-lg border-2 ${
                  ...
                  <div className="flex -mx-3">
                    <div className="w-full px-3 mb-5">
                      <button
                        ...
                        disabled={loading}
                      >
                        {loading ? "Form Submitting..." : "REGISTER NOW"}
                      </button>
                    </div>
                  </div>
                </form>
